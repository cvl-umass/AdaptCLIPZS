...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, required=True, help="checkpoint saving path", default="./ft_clip")  
    parser.add_argument('--text_dir', type=str, required=True, help="where generated gpt descriptions are saved", default="./gpt4_0613_api_StanfordCars")  
    parser.add_argument('--main_lr', type=float, required=True, help="main lr", default=5e-7)  
    parser.add_argument('--main_wd', type=float, required=True, help="main wd", default=1e-2) 
    parser.add_argument('--main_lr', type=float, required=True, help="proj lr", default=1e-7)  
    parser.add_argument('--main_wd', type=float, required=True, help="proj wd", default=1e-2)  
    parser.add_argument('--tau', type=float, required=True, help="temperature", default=2.0)  
